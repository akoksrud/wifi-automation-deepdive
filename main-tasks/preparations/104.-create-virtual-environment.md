...
<mark style="color:yellow;">Now, reload your project by presing</mark> <mark style="color:yellow;"></mark><kbd><mark style="color:yellow;">Ctrl+Shift+P<mark style="color:yellow;"></kbd> <mark style="color:yellow;"></mark><mark style="color:yellow;">and typing</mark> <mark style="color:yellow;"></mark><kbd><mark style="color:yellow;">reload<mark style="color:yellow;"></kbd> <mark style="color:yellow;"></mark><mark style="color:yellow;">and select "Developer: Reload Window"</mark>

<figure><img src="../../.gitbook/assets/image (233).png" alt="" width="563"><figcaption></figcaption></figure>

After reloading, if you have a Python file open (like the `python-hello-world.py`) the virtual environment should show

1.  In VS Code at the bottom right of the screen

    1. If it only shows like this: <img src="../../.gitbook/assets/image (234).png" alt="" data-size="line">, click this text and select the one with .venv in it
    ...
    \
    b. It should show like this: <img src="../../.gitbook/assets/image (236).png" alt="" data-size="line">
2. In the terminal, it will show `(wifi-automation)` before the rest of the text
   1. This is what it should look like:\
      <kbd>(wifi-automation)</kbd> <kbd></kbd><kbd><mark style="color:green;">devnet-adm@ubuntu-devnet:<mark style="color:green;"></kbd><kbd><mark style="color:purple;">\~/wifi-automation<mark style="color:purple;"></kbd> <kbd></kbd><kbd>$</kbd>&#x20;
   2. If it miss the (wifi-automation) at the start, type these commands
...
<div align="left"><figure><img src="../../.gitbook/assets/image (26) (1) (1) (1).png" alt=""><figcaption></figcaption></figure></div>
...
<div align="left"><figure><img src="../../.gitbook/assets/image (28) (1) (1) (1).png" alt=""><figcaption></figcaption></figure></div>
