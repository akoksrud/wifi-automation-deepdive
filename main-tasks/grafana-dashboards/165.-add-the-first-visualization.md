...
(Optional) You can enter [https://yangcatalog.org](/broken/pages/bYlL9leU1zOelLGnd7SF), find the Cisco-IOS-XE-wireless-rrm-oper module and explore which values you could get from this YANG model
