...
*   [ ] Add a new SSH Host
    ...
    * Type "remote-ssh" to narrow down the choices. Select "Remote-SSH: Add New SSH Host..."
    ...
    <figure><img src="../../../.gitbook/assets/image (5) (1) (1) (1).png" alt="" width="345"><figcaption></figcaption></figure>

    * Type in "devnet-adm@192.168.10.7" (replace the IP address with your server IP). Pess Enter.

    <figure><img src="../../../.gitbook/assets/image (6) (1) (1) (1).png" alt="" width="491"><figcaption></figcaption></figure>
