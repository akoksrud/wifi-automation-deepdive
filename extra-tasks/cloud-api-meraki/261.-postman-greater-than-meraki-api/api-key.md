...
You can get Read access to the organization where that the Meraki router and some APs in this lab belong, so you can follow the examples. You can also do the same examples using your own organization of course :)
