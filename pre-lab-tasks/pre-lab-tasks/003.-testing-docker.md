...
If you get the following error message, it is because you didn't reboot after adding your user to the docker group in the [Installing Ubuntu Server](/broken/pages/DVbwDPGlE4L7j22iSwng) section. Go back and double check the steps if it doesn't work after a reboot.
